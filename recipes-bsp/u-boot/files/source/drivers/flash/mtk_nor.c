...
#if defined(__UBOOT_NOR__)
static u32 mtk_nor_erase(u32 addr, u32 len)
{
...
#endif
#if defined(__UBOOT_NOR__)
static u32 mtk_nor_read(u32 from, u32 len, size_t *retlen, u_char *buf)
{
#else
...
#if defined(__UBOOT_NOR__)
static u32 mtk_nor_write(u32 to, u32 len, size_t *retlen, const u_char *buf)
{
#else
